...
public class EditImageActivity extends BaseActivity implements OnLoadingDialogListener {
    ...
    public static void start(Context context, Intent intent, int requestCode) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("khs","EditImageActivity 오픈");
        initView();
        getData();
            ...
            default:
                if (canAutoExit()) {
                    ...
                    alertDialogBuilder.setMessage(R.string.iamutkarshtiwari_github_io_ananas_exit_without_save)
                            .setCancelable(false).setPositiveButton(R.string.iamutkarshtiwari_github_io_ananas_confirm, (dialog, id) -> finishAffinity()).setNegativeButton(R.string.iamutkarshtiwari_github_io_ananas_cancel, (dialog, id) -> dialog.cancel());
    ...
    protected void onSaveTaskDone() {
        ...
        Log.i("test",  String.format("onSaveTaskDone()  sourceFilePath: %s \n outputFilePath : %s ",sourceFilePath ,outputFilePath ));
    ...
    public void loadImageFromFile(String filePath) {
        ...
        Log.i("khs","loadImageFromFile 이값받나");
